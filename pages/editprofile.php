    ...
    <div class="container" >   
        <div class="row " style="border-style: solid; border-width: 1px; padding:15px; margin:1px; border-radius: 5px;">
            <div class="col-md">
              ...
              <a href="profile" class="btn btn-outline-secondary btn-lg btn-block text-wrap">
            ...
            <div class="container" style="border-style: solid; border-width: 1px; padding:20px; border-color: DarkGray; border-radius: 5px;">  
              ...
              <div class="row ">
                ...
                <div class="col-12 col-sm-8 text-truncate">
                    ...
                    <hr class="mt-1 mb-3"/>
                    <form id="coordform" method="get" action="localization" >     
...
<script>
      function initMap() {
        const map = new google.maps.Map(document.getElementById("map"), {
          zoom: <?php echo(isset($_SESSION['lat']) ? "11": "6"); ?>,
          center: { lat: <?php echo($_SESSION['lat'] ?? "51.327"); ?>, lng: <?php echo($_SESSION['lng'] ?? "19.067"); ?> },
        });
        marker = new google.maps.Marker({
          map,
          draggable: true,
          animation: google.maps.Animation.DROP,
          position: { lat: <?php echo($_SESSION['lat'] ?? "51.327"); ?>, lng: <?php echo($_SESSION['lng'] ?? "19.067"); ?> },
        });
